...
enum lfs_type {
    ...
    LFS_TYPE_SPLICE         = 0xe00,
    LFS_TYPE_FILE           = 0x000,
    LFS_TYPE_STRUCT         = 0x400,
    LFS_TYPE_USERATTR       = 0x600,
    LFS_TYPE_FROM           = 0x200,
    LFS_TYPE_TAIL           = 0x800,
    LFS_TYPE_GLOBALS        = 0xa00,
    LFS_TYPE_CRC            = 0xc00,

    // internally used type specializations
    LFS_TYPE_CREATE         = 0xe00,
    LFS_TYPE_DELETE         = 0xf00,
    LFS_TYPE_SUPERBLOCK     = 0x1ff,
    LFS_TYPE_DIRSTRUCT      = 0x400,
    LFS_TYPE_CTZSTRUCT      = 0x401,
    LFS_TYPE_INLINESTRUCT   = 0x500,
    LFS_TYPE_SOFTTAIL       = 0x800,
    LFS_TYPE_HARDTAIL       = 0x801,
